...
require_once "../../../money.ini.php";
    ...
    $mny_cat_id         = $_GET["mny_cat_id"];
    
    if ($mny_cat_id) {
        
            $sSql = "SHOW COLUMNS FROM money_categoria ";
            ...
            if ($SqlResult_1->NumRows() > 0) {
                ...
                $sSql .= " FROM money_categoria WHERE mny_cat_id = $mny_cat_id";
...
<input type="hidden" value="<?=$mny_cat_id?>" id="mny_cat_id" name="mny_cat_id">
    <div class="row">
                ...
                <div class="panel-heading">
                     <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div><h1>Cadastro de Categoria</h1></div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class='row'>
                                    <table cellpadding=0 cellspacing=0 border=0 width=100%>
                                        ...
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td align=left>
                                                <button onclick="window.location.href = '<?=$sUrlRaiz?>sis/categoria/cadastro/modal.php'" type="button" class="btn btn-warning" data-placement="top" title="Ctrl+N">NOVO</button> 
                                            </td>    
                                            <td>&nbsp;&nbsp;</td>
                                            <td align=left>
                                            ...
                                            <td align=right width="99%">
                                                <button onclick="excluir_registro(<?=$mny_cat_id?>)" type="button" class="btn btn-danger">EXCLUIR</button> 
                                            </td>    
                                            <td>&nbsp;&nbsp;</td>
                                        </tr>  
                                        <tr><td colspan="20" height="10"></td></td>
                            ...
                            <div class='row'>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" type="text" name="mny_cat_descricao" id="mny_cat_descricao" value="<?=$mny_cat_descricao?>"/>                                
                                    </div>  
                            </div>  
                    </div>    
                </form>
...
<script>
    $(document).ready(function(){
      $(document).keypress(function(e){
            ...
            if(e.wich == 14 || e.keyCode == 14){
                window.location.href = '<?=$sUrlRaiz?>sis/categoria/cadastro/modal.php';                        
            }
    ...
    $('#form-categoria').submit(function(){      
        ...
        $.ajax({
             ...
             method: 'POST',
             data: {
                mny_cat_id:$("#mny_cat_id").val(),
                mny_cat_descricao:$("#mny_cat_descricao").val()
             },
                beforeSend:function(){
    ...
    function excluir_registro(mny_cat_id){
