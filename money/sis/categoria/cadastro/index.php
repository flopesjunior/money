...
<!-- MetisMenu CSS -->
  ...
  <body style="padding-left: 10; padding-top: 10; padding-right: 10">
      ...
      <?=fCabecalho("CADASTRO DE CATEGORIA")?>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
             ...
             $link = "onClick=\"JavaScript:window.open('".$sUrlRaiz."sis/categoria/cadastro/modal.php','categoriamodal','width=1280,height=550,top=10,left=10,scrollbars=yes,location=no,directories=no,status=yes,menubar=no,toolbar=no,resizable=yes');\"";
                ...
                <td>
                    <table width="1%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td>&nbsp;&nbsp;</td>
                            <td>
                                <button type="button" class="btn btn-success" onclick="window.location.href = '<?=$sUrlRaiz?>sis/categoria/cadastro/index.php'">ATUALIZAR</button>
                            </td>
                        </tr>
                    </table> 
                </td>    
...
//                                    echo $sSql."<BR>";
                                    ...
                                    if ($SqlResult_1->NumRows() > 0) {
                                        ...
                                        while (!$SqlResult_1->EOF) {
                                            ...
                                            $linkEdit = "onClick=\"JavaScript:window.open('".$sUrlRaiz."sis/categoria/cadastro/modal.php?mny_cat_id=$mny_cat_id','categoriamodal','width=1280,height=550,top=10,left=10,scrollbars=yes,location=no,directories=no,status=yes,menubar=no,toolbar=no,resizable=yes');\"";
