...
<html>
  <head>
    <title>ORIGEM <?=$sNomeSistema?></title>
...
<!-- MetisMenu CSS -->
  ...
  <body style="padding-left: 10; padding-top: 10; padding-right: 10">
      ...
      <?=fCabecalho("CADASTRO DE ORIGEM DA MOVIMENTAÇÃO")?>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
             ...
             $link = "onClick=\"JavaScript:window.open('".$sUrlRaiz."sis/origem/cadastro/modal.php','origemmodal','width=1280,height=550,top=10,left=10,scrollbars=yes,location=no,directories=no,status=yes,menubar=no,toolbar=no,resizable=yes');\"";
                ...
                <td>
                    <table width="1%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td>&nbsp;&nbsp;</td>
                            <td>
                                <button type="button" class="btn btn-success" onclick="window.location.href = '<?=$sUrlRaiz?>sis/origem/cadastro/index.php'">ATUALIZAR</button>
                            </td>
                        </tr>
                    </table> 
                </td>    
...
//                                    echo $sSql."<BR>";
                                    ...
                                    if ($SqlResult_1->NumRows() > 0) {
                                        ...
                                        while (!$SqlResult_1->EOF) {
                                            ...
                                            $linkEdit = "onClick=\"JavaScript:window.open('".$sUrlRaiz."sis/origem/cadastro/modal.php?mny_ori_id=$mny_ori_id','cadastro','width=1280,height=550,top=10,left=10,scrollbars=yes,location=no,directories=no,status=yes,menubar=no,toolbar=no,resizable=yes');\"";
