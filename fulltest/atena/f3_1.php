...
//        }
   ...
   $qtd_questoes  = $SqlResult_1->fields["qtd_questoes"];      
                                                    ...
                                                    <table width ="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td width="99%" align="right">
                                                                 <h6><font color="#CCCCCC">ref: <?=$ftt_per_id?></font></h6>
                                                            </td>
                                                        </tr>
                                                    </table> 
                                                </td>    
                                                                                      ...
                                                                                      <td>
                                                                                         <table border=\"0\" cellspacing=\"0\" cellpadding=\"0\">   
                                                                                            <tr>
                                                                                              ...
                                                                                              <td>&nbsp;&nbsp;</td>    
                                                                                              <td width=1%  valign=top><input type=\"radio\" name=\"optionsAlternativas\" id=\"optionsAlternativas\" value=\"$ftt_alt_id\"></td>
                                                                                              <td>&nbsp;&nbsp;</td>    
                                                                                      ...
                                                                                      <td>
                                                                                         <table border=\"0\" cellspacing=\"0\" cellpadding=\"0\">   
                                                                                            <tr>
                                                                                              <td width=1%  valign=top>".$ftt_alt_ordem.".</td>
                                                                                              <td>&nbsp;&nbsp;</td>    
                                                                                              <td width=1%  valign=top><input type=\"checkbox\" name=\"optionsAlternativas\" id=\"optionsAlternativas\" value=\"$ftt_alt_id\"></td>
                                                                                              <td>&nbsp;&nbsp;</td>    
                                                                                              <td width=99%  valign=top>
                                                                                                    $ftt_alt_desc
                                                                                              </td>
             ...
             <tr>
                <td align="center">
                    <table width="50%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td>
                                <button type="button" class="btn btn-danger" onclick="anula_questao();">EU NÃO SEI</button>
                            </td>
                            <td>&nbsp;&nbsp;</td>
                            <td align="right">
                                <button type="button" class="btn btn-success" onclick="registra_questao();">ENVIAR</button>
                            </td>
                        </tr>
                    </table> 
                </td>    
