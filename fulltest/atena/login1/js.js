...
function login_teste(){ //AUTENTICA��O
var sUrlRaiz = document.getElementById('sUrlRaiz').value;
var sUrlAlvo = sUrlRaiz + "/atena/login1/login.php";
    ...
    ajax.onreadystatechange = function() {
        ...
        if(ajax.readyState == 4 ) {
            ...
            if (retorno.trim() == "TRUE") {
                    window.location = sUrlRaiz + "atena/index.php";
                    return;
            }
            else if (retorno.trim() == "FALSE"){
                    alert("NÃO EXISTE HAVALIAÇÃO EM ABERTO PARA O EMAIL \n\n"+sLogin);
